...
export docker_base_path_iscsi="/data/downloads_common" #"/mnt/iscsi"
export movies_path="$docker_base_path_iscsi/movies"
export tv_path="$docker_base_path_iscsi/tv"
export comics_path="$docker_base_path_iscsi/comics"
...
export subdomains="www nzbget couchpotato mylar plex deluge sonarr graylog grafana vpn influxdb"
